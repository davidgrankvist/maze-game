...
import { setPlayerName } from "../common/localStorage";
    ...
    <div className="flex justify-center">
      <form onSubmit={handleSubmit} className="form-control">
        <label className="input-group">
          <span>Name</span>
          <input name="name" type="text" required={true} placeholder="Your character name" className="input input-bordered" autoComplete="off" />
        </label>
        <label className="input-group mt-2">
          <span>Room</span>
          <input name="room" type="text" required={true} placeholder="The room code" className="input input-bordered" autoComplete="off" />
        </label>
